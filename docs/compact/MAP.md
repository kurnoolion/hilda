...
| template_schemas (customizations) | Per-customer template.yaml drop-zone — populated 2026-06-21 with MMK template (Galaxy S22 SM-S901U / milestone P1 / 10 work-items). | **[NEW]** — MODULE.md needed |
...
│       └── MMK/                               # MMK (carrier MMK) — Galaxy S22 / milestone P1 / 10 work items.
